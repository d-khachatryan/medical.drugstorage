CREATE VIEW dbo.vwDrugItem
AS
SELECT     dbo.Drug.DrugId, dbo.Drug.Seria, dbo.Drug.DrugName, dbo.Drug.UnitTypeId, dbo.UnitType.UnitTypeName, dbo.Drug.ExpirationDate, dbo.Drug.SupplierId, dbo.Supplier.SupplierName, 
                      dbo.Drug.CountryId, dbo.Country.CountryName, dbo.Drug.Manufacturer, dbo.Drug.UnitCost, dbo.Drug.DrugClassId, dbo.Drug.OrganizationId, dbo.Organization.OrganizationCode, 
                      dbo.Organization.OrganizationName, dbo.Drug.StoreOrganizationId, Organization_1.OrganizationCode AS StoreOrganizationCode, Organization_1.OrganizationName AS StoreOrganizationName, 
                      dbo.Drug.Quantity, dbo.Drug.TotalCost, dbo.Drug.DrugSourceId, dbo.DrugSource.DrugSourceName, dbo.Drug.ItemQuantity, dbo.Drug.Description, dbo.DrugClass.GenericName, 
                      dbo.DrugClass.ProductCategoryId, dbo.DrugClass.ProductGroupId, dbo.DrugClass.ProductTypeId, dbo.ProductCategory.ProductCategoryName, dbo.ProductGroup.ProductGroupName, 
                      dbo.ProductType.ProductTypeName, dbo.DrugClass.DrugTypeId, dbo.DrugClass.DrugCategoryId, dbo.DrugType.DrugTypeName, dbo.DrugCategory.DrugCategoryName, 
                      dbo.DrugClass.DrugClassName, dbo.DrugClass.DrugClassStatus
      ...
      Begin Tables = 
         ...
         Begin Table = "Organization_1"
            Begin Extent = 
               ...
               Right = 464
            End
     ', @level0type = N'SCHEMA', @level0name = N'dbo', @level1type = N'VIEW', @level1name = N'vwDrugItem';
...
GO
EXECUTE sp_addextendedproperty @name = N'MS_DiagramPaneCount', @value = 2, @level0type = N'SCHEMA', @level0name = N'dbo', @level1type = N'VIEW', @level1name = N'vwDrugItem';
