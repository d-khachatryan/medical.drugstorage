...
-- =============================================
CREATE FUNCTION [dbo].[tfnDestinationOrganizationReplacementPeriod]
(	
@StartDate date,
...
FROM         dbo.Organization INNER JOIN
                      dbo.Replacement ON dbo.Organization.OrganizationId = dbo.Replacement.DestinationOrganizationId INNER JOIN
