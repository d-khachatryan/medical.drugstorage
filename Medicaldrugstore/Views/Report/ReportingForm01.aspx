...
<head runat="server">
    ...
    <script runat="server">
        ...
        {
            var adap = new SqlDataAdapter("dbo.Report01", ConfigurationManager.ConnectionStrings["MedicalDrugStoreConnection"].ConnectionString);
            ...
            rpv.LocalReport.ReportPath = Server.MapPath("~/bin/RDLC/") + "Report01.rdlc";
