...
<head runat="server">
    ...
    <script runat="server">
        ...
        {
            var adap = new SqlDataAdapter("dbo.Report06", ConfigurationManager.ConnectionStrings["MedicalDrugStoreConnection"].ConnectionString);
            ...
            rpv.LocalReport.ReportPath = Server.MapPath("~/bin/RDLC/") + "Report06.rdlc";
