...
<head runat="server">
    ...
    <script runat="server">
        ...
        {
            var adap = new SqlDataAdapter("dbo.Report07", ConfigurationManager.ConnectionStrings["MedicalDrugStoreConnection"].ConnectionString);
            ...
            adap.SelectCommand.Parameters.Add("@MarzId", SqlDbType.Int).Value = ViewBag.MarzId;
            ...
            prms.Add(new ReportParameter("MarzName", ViewBag.MarzName));
            rpv.ProcessingMode = ProcessingMode.Local;
            rpv.Reset();
            rpv.LocalReport.DisplayName = "---";
            rpv.LocalReport.ReportPath = Server.MapPath("~/bin/RDLC/") + "Report07.rdlc";
