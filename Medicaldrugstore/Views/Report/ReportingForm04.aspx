...
<head runat="server">
    ...
    <script runat="server">
        ...
        {
            var adap = new SqlDataAdapter("dbo.Report04", ConfigurationManager.ConnectionStrings["MedicalDrugStoreConnection"].ConnectionString);
            ...
            rpv.LocalReport.ReportPath = Server.MapPath("~/bin/RDLC/") + "Report04.rdlc";
