...
<head runat="server">
    ...
    <script runat="server">
        ...
        {
            var adap = new SqlDataAdapter("dbo.Report05", ConfigurationManager.ConnectionStrings["MedicalDrugStoreConnection"].ConnectionString);
            adap.SelectCommand.CommandType = System.Data.CommandType.StoredProcedure;
            adap.SelectCommand.CommandTimeout = 180;
            adap.SelectCommand.Parameters.Add("@ReportDate", SqlDbType.DateTime).Value = Convert.ToDateTime(ViewBag.ReportDate);
            ...
            prms.Add(new ReportParameter("ReportDate", ViewBag.ReportDate));
            ...
            rpv.LocalReport.ReportPath = Server.MapPath("~/bin/RDLC/") + "Report05.rdlc";
