...
<head runat="server">
    ...
    <script runat="server">
        ...
        {
            var adap = new SqlDataAdapter("dbo.Report03", ConfigurationManager.ConnectionStrings["MedicalDrugStoreConnection"].ConnectionString);
            ...
            adap.SelectCommand.Parameters.Add("@DiagnoseId", SqlDbType.Int).Value = ViewBag.DiagnoseId;
            ...
            prms.Add(new ReportParameter("DiagnoseName", ViewBag.DiagnoseName));
            rpv.ProcessingMode = ProcessingMode.Local;
            rpv.Reset();
            rpv.LocalReport.DisplayName = "---";
            rpv.LocalReport.ReportPath = Server.MapPath("~/bin/RDLC/") + "Report03.rdlc";
